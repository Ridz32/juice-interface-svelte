export default {
  "address": "0x0E5a62BA8f946AB98c1E801Fc0a7264408f6B838",
  "abi": [
    {
      "inputs": [
        {
  ...
  "transactionHash": "0xe9bb80a2682b5ec7ff02dc4f552d8db3929bcf55ff8980c834eee8bd50d726d2",
  "receipt": {
    "to": null,
    "from": "0xE9bE6df23C7f9CaBa3005DA2fa2d8714d340D0aF",
    "contractAddress": "0x0E5a62BA8f946AB98c1E801Fc0a7264408f6B838",
    "transactionIndex": 0,
    "gasUsed": "5371390",
    "logsBloom": "",
    "blockHash": "0xd9acccf078ead3ce8ee37ed9e047c0c8e27eef97e4c3b977ecf7ddba91e77cad",
    "transactionHash": "0xe9bb80a2682b5ec7ff02dc4f552d8db3929bcf55ff8980c834eee8bd50d726d2",
    "logs": [
      {
        "transactionIndex": 0,
        "blockNumber": 10550772,
        "transactionHash": "0xe9bb80a2682b5ec7ff02dc4f552d8db3929bcf55ff8980c834eee8bd50d726d2",
        "address": "0x0E5a62BA8f946AB98c1E801Fc0a7264408f6B838",
        "topics": [
  ...
  "args": [
    ...
    "0x99cfB209b273562e1F72863BAa1F40c1Ea96e124",
    "0x1f33E21A5D422C6E260c1641E9A802a0B887E074",
  ...
  "devdoc": {
    ...
    "methods": {
      ...
      "addToBalanceOf(uint256,uint256,address,string,bytes)": {
        "params": {
          "_amount": "The amount of tokens to add, as a fixed point number with the same number of decimals as this terminal. If this is an ETH terminal, this is ignored and msg.value is used instead. ignored: _token The token being paid. This terminal ignores this property since it only manages one currency. ",
      ...
      "distributePayoutsOf(uint256,uint256,uint256,address,uint256,string)": {
        ...
        "params": {
          ...
          "_currency": "The expected currency of the amount being distributed. Must match the project's current funding cycle's distribution limit currency. ignored: _token The token being distributed. This terminal ignores this property since it only manages one token. ",
          "_memo": "A memo to pass along to the emitted event.",
      ...
      "pay(uint256,uint256,address,address,uint256,bool,string,bytes)": {
        "params": {
          "_amount": "The amount of terminal tokens being received, as a fixed point number with the same amount of decimals as this terminal. If this terminal's token is ETH, this is ignored and msg.value is used in its place. ignored: _token The token being paid. This terminal ignores this property since it only manages one token. ",
      ...
      "redeemTokensOf(address,uint256,uint256,address,uint256,address,string,bytes)": {
        ...
        "params": {
          ...
          "_tokenCount": "The number of project tokens to redeem, as a fixed point number with 18 decimals. ignored: _token The token being reclaimed. This terminal ignores this property since it only manages one token. "
        },
        "returns": {
      ...
      "useAllowanceOf(uint256,uint256,uint256,address,uint256,address,string)": {
        ...
        "params": {
          ...
          "_currency": "The expected currency of the amount being distributed. Must match the project's current funding cycle's overflow allowance currency. ignored: _token The token being distributed. This terminal ignores this property since it only manages one token. ",
          "_memo": "A memo to pass along to the emitted event.",
  ...
  "userdoc": {
    ...
    "methods": {
      ...
      "currencyForToken(address)": {
        "notice": "The currency that should be used for the specified token. ignored: _token The token to check for the currency of."
      },
      "currentEthOverflowOf(uint256)": {
      ...
      "decimalsForToken(address)": {
        "notice": "The decimals that should be used in fixed number accounting for the specified token. ignored: _token The token to check for the decimals of."
      },
      "directory()": {
