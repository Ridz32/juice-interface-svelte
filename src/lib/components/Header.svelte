...
>
	...
	>
		<div class="ant-space-item" style="">
			<a href="/" style="display: inline-block;">
				<img src="/juice_logo-ol.png" alt="Juicebox logo" style="height: 40px;" />
			</a>
		</div>
		<div class="ant-space-item" style="">
			<a
		...
		<div class="ant-space-item">
			...
			>
				Resources<span
					...
					style="font-size: 13px; margin-left: 7px;"
					><svg
	...
	>
		...
		<div class="ant-space-item" style="">
			<div
				class="clickable-border"
				role="switch"
				aria-checked="false"
				style="display: flex; align-items: center; justify-content: space-evenly; cursor: pointer; width: 60px; margin-right: 10px; height: 30px; border-radius: 15px;"
			>
				<div
					style="display: flex; align-items: center; justify-content: center; padding-top: 6px; padding-bottom: 6px; color: rgba(0, 0, 0, 0.933);"
				>
					<svg
						viewBox="0 0 24 24"
						width="18"
				...
				<div
					style="display: flex; align-items: center; justify-content: center; padding-top: 6px; padding-bottom: 6px; color: rgba(0, 0, 0, 0.333);"
				>
					<svg
						viewBox="0 0 24 24"
						width="18"
