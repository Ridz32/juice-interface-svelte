...
> &
	Record<
		keyof Pick<EditingV1FundingCycle, 'payIsPaused' | 'ticketPrintingIsAllowed'>,
		null | boolean
	> &
	Record<keyof Pick<EditingV1FundingCycle, 'treasuryExtension'>, null | string>;

export const serializeV1FundingCycle = (fc: EditingV1FundingCycle): SerializedV1FundingCycle => ({
...
export const deserializeV1FundingCycle = (fc: SerializedV1FundingCycle): EditingV1FundingCycle => ({
	...fc,
