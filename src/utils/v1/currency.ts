...
import type { CurrencyName, CurrencySymbol } from '$constants/currency';

import { V1_CURRENCY_ETH, V1_CURRENCY_METADATA, V1_CURRENCY_USD } from '$constants/v1/currency';
...
export const V1CurrencyName = (currency?: V1CurrencyOption): CurrencyName | undefined =>
	currency !== undefined ? V1_CURRENCY_METADATA[currency].name : undefined;

export const getV1CurrencyOption = (currencyName: CurrencyName): V1CurrencyOption =>
	currencyName === 'ETH' ? V1_CURRENCY_ETH : V1_CURRENCY_USD;

export const V1CurrencySymbol = (currency?: V1CurrencyOption): CurrencySymbol | undefined =>
...
export const toV1Currency = (v2Currency: V2CurrencyOption): V1CurrencyOption => {
