...
export type SerializedV2FundAccessConstraint = Record<keyof V2FundAccessConstraint, string>;
...
export const serializeFundAccessConstraint = (
	...
	return {
		...
		distributionLimitCurrency: fundAccessConstraint.distributionLimitCurrency.toString(),
		overflowAllowance: fromWad(fundAccessConstraint.overflowAllowance),
		overflowAllowanceCurrency: fundAccessConstraint.overflowAllowanceCurrency.toString()
	};
};
...
export const deserializeFundAccessConstraint = (
	...
	return {
		...
		distributionLimitCurrency: BigNumber.from(fundAccessConstraint.distributionLimitCurrency),
