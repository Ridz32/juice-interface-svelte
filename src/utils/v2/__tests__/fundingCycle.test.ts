 ...
 */
export function packFundingCycleMetadata(packedMetadata: V2FundingCycleMetadata) {
...
describe('fundingCycle', () => {
	describe('decodeV2FundingCycleMetadata', () => {
		it.each`
			...
			${true}
			${false}
		`('decodes metadata correctly when flagsEnabled is $flagsEnabled', ({ flagsEnabled }) => {
