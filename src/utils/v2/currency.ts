...
import type { V2CurrencyETH, V2CurrencyOption, V2CurrencyUSD } from '$models/v2/currencyOption';
...
export const toV2Currency = (v1Currency: V1CurrencyOption): V2CurrencyOption => {
